...
import LlmCostCalculatorPage from './pages/LlmCostCalculatorPage'
...
import PixPayloadGeneratorPage from './pages/PixPayloadGeneratorPage'
...
const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'cloud/aws-sigv4-signature-generator', element: <AwsSigv4SignatureGeneratorPage /> },
      ...
      { path: 'ai/anthropic-cost-calculator', element: <Navigate to="/ai/llm-cost-calculator" replace /> },
      { path: 'ai/openai-cost-calculator', element: <Navigate to="/ai/llm-cost-calculator" replace /> },
      { path: 'ai/llm-cost-calculator', element: <LlmCostCalculatorPage /> },
      ...
      { path: 'frontend/conic-gradient-generator', element: <Navigate to="/frontend/gradient-generator" replace /> },
      ...
      { path: 'text/lines-tool', element: <Navigate to="/text/lines-processor" replace /> },
      { path: 'text/lines-processor', element: <LinesToolPage /> },
      ...
      { path: 'database/sql-formatter', element: <Navigate to="/tools/sql-formatter" replace /> },
      { path: 'tools/sql-formatter', element: <SqlFormatterPage /> },
      { path: 'tools/graphql-formatter', element: <GraphqlFormatterPage /> },
      ...
      { path: 'network/mac-address-generator', element: <MacAddressToolPage /> },
      ...
      { path: 'tools/aws-sigv4-signature-generator', element: <Navigate to="/cloud/aws-sigv4-signature-generator" replace /> },
      ...
      { path: 'references/grep-sed-awk', element: <Navigate to="/references/grep-sed-awk-cheatsheet" replace /> },
      { path: 'references/grep-sed-awk-cheatsheet', element: <GrepSedAwkCheatsheetPage /> },
      ...
      { path: 'references/bash-scripting', element: <Navigate to="/references/bash-scripting-cheatsheet" replace /> },
      { path: 'references/bash-scripting-cheatsheet', element: <BashScriptingCheatsheetPage /> },
      ...
      { path: 'tools/pix-payload-generator', element: <PixPayloadGeneratorPage /> },
      ...
      { path: 'references/redis-commands', element: <Navigate to="/references/redis-cheatsheet" replace /> },
      { path: 'references/redis-cheatsheet', element: <RedisCheatsheetPage /> },
      ...
      { path: 'references/design-patterns', element: <Navigate to="/references/design-patterns-cheatsheet" replace /> },
      { path: 'references/design-patterns-cheatsheet', element: <DesignPatternsCheatsheetPage /> },
