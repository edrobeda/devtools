...
export const LABELS = {
  pt: {
    ...
    'cron-schedule-timeline': 'Linha do Tempo de Cron',
  ...
  en: {
    ...
    'cron-schedule-timeline': 'Cron Schedule Timeline',
  ...
  return [
    ...
    { key: '/bastidores', icon: <HistoryOutlined />, label: l.bastidores },
    {
      ...
      children: [
        ...
        { key: '/tools/cron-schedule-timeline', icon: <FieldTimeOutlined />, label: withNewBadge('/tools/cron-schedule-timeline', l['cron-schedule-timeline'], l) },
