...
export const LABELS = {
  pt: {
    ...
    'css-has-selector-tester': 'Testador de :has() CSS',
    ...
    'emoji-reference': 'Referência de Emojis Unicode',
  ...
  en: {
    ...
    'css-has-selector-tester': 'CSS :has() Selector Tester',
    ...
    'emoji-reference': 'Unicode Emoji Reference',
  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/references/emoji-reference', icon: <SmileOutlined />, label: withNewBadge('/references/emoji-reference', l['emoji-reference'], l) },
