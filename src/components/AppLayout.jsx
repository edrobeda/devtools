...
export const LABELS = {
  pt: {
    ...
    'llm-cost-calculator': 'Calculadora de Custo de LLM (OpenAI/Anthropic)',
    ...
    'base58-tool': 'Base58 / Base58Check',
    'base85-tool': 'Base85 / Ascii85 Encode/Decode',
    'uuid-generator': 'Gerador de UUID',
    'uuid-v7-tool': 'Gerador / Decoder de UUID v7 & ULID',
    'snowflake-id-tool': 'Gerador / Decoder de Snowflake ID',
    ...
    'sql-in-list-generator': 'Gerador de Cláusula SQL IN',
    'availability-calculator': 'Calculadora de Disponibilidade',
    'littles-law-calculator': 'Lei de Little',
    'queueing-theory-calculator': 'Teoria das Filas',
    'pert-calculator': 'Calculadora PERT',
    'confidence-interval-calculator': 'Calculadora de Intervalo de Confiança',
    'downtime-cost-calculator': 'Calculadora de Custo de Downtime',
    'sre-burn-rate-calculator': 'Calculadora de Burn Rate SRE',
    'amdahls-law-calculator': 'Lei de Amdahl',
    'unicode-normalizer': 'Normalizador de Texto Unicode',
    'brazilian-data-generator': 'Gerador de Dados Brasileiros',
    'bankers-algorithm-simulator': 'Algoritmo do Banqueiro',
    'memory-allocation-simulator': 'Simulador de Alocação de Memória',
    'raft-simulator': 'Simulador de Raft',
    'paxos-simulator': 'Simulador de Paxos',
    'bully-algorithm-simulator': 'Algoritmo do Bully',
    ...
    'combinatorics-calculator': 'Calculadora de Combinatória',
    ...
    'priority-queue': 'Priority Queue (Binary Heap)',
    'branch-name-generator': 'Gerador de Nome de Branch',
    'lines-processor': 'Processador de Linhas',
    ...
    'network-latency-calculator': 'Calculadora de Latência de Rede',
    ...
    'load-balancer-simulator': 'Simulador de Load Balancer',
    'consistent-hashing-simulator': 'Simulador de Consistent Hashing',
    'hash-table-visualizer': 'Visualizador de Tabela Hash',
    'bloom-filter-simulator': 'Simulador de Bloom Filter',
    'cpu-scheduling-simulator': 'Simulador de Escalonamento de CPU',
    'disk-scheduling-simulator': 'Simulador de Escalonamento de Disco',
    'gossip-protocol-simulator': 'Simulador de Gossip Protocol',
    'page-replacement-simulator': 'Simulador de Substituição de Página',
    'cache-simulator': 'Simulador de Cache de Memória',
    'merkle-tree-simulator': 'Simulador de Merkle Tree',
    'quorum-nwr-simulator': 'Simulador de Quorum NWR',
    'descriptive-statistics-calculator': 'Calculadora de Estatistica Descritiva',
    'bmi-calculator': 'Calculadora de IMC',
    'logical-clocks-simulator': 'Simulador de Relógios Lógicos',
    'mapreduce-simulator': 'Simulador de MapReduce',
    'circuit-breaker-simulator': 'Simulador de Circuit Breaker',
    'rate-limiter-simulator': 'Simulador de Rate Limiter',
    'two-phase-commit-simulator': 'Simulador de Two-Phase Commit',
    'three-phase-commit-simulator': 'Simulador de Three-Phase Commit',
    ...
    'deadlock-simulator': 'Simulador de Deadlock',
    'truth-table-generator': 'Gerador de Tabela Verdade',
    ...
    'matrix-calculator': 'Calculadora de Matrizes',
    ...
    'csv-markdown-table': 'Tabela CSV ↔ Markdown',
    ...
    'svg-blob-generator': 'Gerador de Blob SVG',
    ...
    'css-mask-generator': 'Gerador de CSS Mask',
    'toml-formatter': 'Formatador de TOML',
    'yaml-formatter': 'Formatador de YAML',
    'regex-cheatsheet': 'Cheat Sheet de Regex',
    'crc-calculator': 'Calculadora de CRC',
    'json-to-types': 'JSON → Tipos Multi-Lingua',
    ...
    'docker-compose-visualizer': 'Visualizador de docker-compose',
    ...
    'rsync-cheatsheet': 'Comandos rsync',
    'tar-compression-cheatsheet': 'Cheat Sheet de tar & Compactação',
    'python-cheatsheet': 'Cheat Sheet de Python',
    'grep-sed-awk-cheatsheet': 'grep/sed/awk',
    'jq-cheatsheet': 'Comandos jq',
    'curl-cheatsheet': 'Comandos curl',
    'changelog-generator': 'Gerador de Changelog',
    'scrollbar-generator': 'Gerador de Scrollbar CSS',
    'bash-scripting-cheatsheet': 'Scripts em Bash (shell scripting)',
    'systemd-commands': 'Comandos systemd',
    'credit-card-tool': 'Gerador/Validador de Cartão (Luhn)',
    'qr-code-generator': 'Gerador de QR Code',
    'pix-payload-generator': 'Gerador de Payload PIX (Copia e Cola)',
    ...
    'redis-cheatsheet': 'Comandos Redis',
    ...
    'font-stack-generator': 'Gerador de Font Stack',
    ...
    'playwright-cheatsheet': 'Cheat Sheet de Playwright (E2E)',
    ...
    'terraform-cheatsheet': 'Cheat Sheet de Terraform',
    'nodejs-cheatsheet': 'Cheat Sheet de Node.js',
    'postgresql-cheatsheet': 'Cheat Sheet de PostgreSQL',
    'go-cheatsheet': 'Cheat Sheet de Go',
    'rust-cheatsheet': 'Cheat Sheet de Rust',
    'java-cheatsheet': 'Cheat Sheet de Java',
    'sqlite-cheatsheet': 'Cheat Sheet de SQLite',
    'ffmpeg-cheatsheet': 'Cheat Sheet de FFmpeg',
    'csharp-cheatsheet': 'Cheat Sheet de C# (.NET)',
    'php-cheatsheet': 'Cheat Sheet de PHP',
    'kotlin-cheatsheet': 'Cheat Sheet de Kotlin',
    'tcpdump-cheatsheet': 'Cheat Sheet de tcpdump',
    'jwt-claims-cheatsheet': 'Cheat Sheet de Claims JWT',
    'oauth2-cheatsheet': 'Cheat Sheet de OAuth2 / OIDC',
    'design-patterns-cheatsheet': 'Cheat Sheet de Design Patterns',
    'grid-areas-generator': 'Gerador de Grid Areas CSS',
    'grid-builder': 'Gerador de Grid CSS',
    'pattern-background-generator': 'Gerador de Padrões de Fundo CSS',
    'sitemap-generator': 'Gerador de Sitemap XML',
    'web-app-manifest-generator': 'Gerador de Web App Manifest',
    'json-ld-generator': 'Gerador de Structured Data (JSON-LD / schema.org)',
    ...
    'svg-sprite-generator': 'Gerador de SVG Sprite',
    ...
    'image-palette-extractor': 'Extrator de Paleta de Imagem',
    'image-diff-visualizer': 'Visualizador de Diff de Imagens',
    ...
    'css-supports-generator': 'Gerador de @supports CSS',
    'css-layer-generator': 'Gerador de @layer CSS',
    ...
    'disk-performance-calculator': 'Calculadora de Performance de Disco',
    'systemd-unit-generator': 'Gerador de Unidade systemd',
    'shields-badge-generator': 'Gerador de Badge',
    ...
    'grpc-cheatsheet': 'Cheat Sheet de gRPC & Protobuf',
    'ruby-cheatsheet': 'Cheat Sheet de Ruby',
    'swift-cheatsheet': 'Cheat Sheet de Swift',
  ...
  en: {
    ...
    'llm-cost-calculator': 'LLM Cost Calculator (OpenAI/Anthropic)',
    'llm-prompt-builder': 'LLM Prompt Builder',
    ...
    'uuid-v7-tool': 'UUID v7 & ULID Generator / Decoder',
    'snowflake-id-tool': 'Snowflake ID Generator / Decoder',
    ...
    'sql-in-list-generator': 'SQL IN Clause Generator',
    'availability-calculator': 'Availability Calculator',
    'littles-law-calculator': "Little's Law Calculator",
    'queueing-theory-calculator': 'Queueing Theory Calculator',
    'pert-calculator': 'PERT Calculator',
    'confidence-interval-calculator': 'Confidence Interval Calculator',
    'downtime-cost-calculator': 'Downtime Cost Calculator',
    'sre-burn-rate-calculator': 'SRE Burn Rate Calculator',
    'amdahls-law-calculator': "Amdahl's Law",
    'unicode-normalizer': 'Unicode Text Normalizer',
    ...
    'raft-simulator': 'Raft Simulator',
    'paxos-simulator': 'Paxos Simulator',
    'bully-algorithm-simulator': 'Bully Algorithm',
    ...
    'combinatorics-calculator': 'Combinatorics Calculator',
    'use-window-size': 'useWindowSize',
    ...
    'aws-sigv4-signature-generator': 'AWS SigV4 Signature Generator',
    'lorem-ipsum-generator': 'Lorem Ipsum Generator',
    'json-diff': 'JSON Diff',
    'json-patch': 'JSON Patch Applier (RFC 6902)',
    'json-merge-patch': 'JSON Merge Patch (RFC 7396)',
    'dark-mode-toggle': 'Dark Mode Toggle',
    'use-throttle': 'useThrottle',
    'vscode-shortcuts': 'VSCode Shortcuts',
    'intellij-shortcuts': 'IntelliJ IDEA Shortcuts',
    'json-path-explorer': 'JSON Path Explorer',
    ...
    'lines-processor': 'Text Lines Processor',
    ...
    'mac-address-generator': 'MAC Generator / Validator',
    'cidr-overlap-aggregator': 'CIDR Overlap & Aggregator',
    'websocket-tester': 'WebSocket Tester',
    'sse-tester': 'SSE Tester',
    ...
    'network-latency-calculator': 'Network Latency Calculator',
    ...
    'load-balancer-simulator': 'Load Balancer Simulator',
    'consistent-hashing-simulator': 'Consistent Hashing Simulator',
    'hash-table-visualizer': 'Hash Table Visualizer',
    'bloom-filter-simulator': 'Bloom Filter Simulator',
    'cpu-scheduling-simulator': 'CPU Scheduling Simulator',
    'disk-scheduling-simulator': 'Disk Scheduling Simulator',
    'gossip-protocol-simulator': 'Gossip Protocol Simulator',
    'page-replacement-simulator': 'Page Replacement Simulator',
    'cache-simulator': 'Memory Cache Simulator',
    'merkle-tree-simulator': 'Merkle Tree Simulator',
    'quorum-nwr-simulator': 'NWR Quorum Simulator',
    'descriptive-statistics-calculator': 'Descriptive Statistics Calculator',
    'bmi-calculator': 'BMI Calculator',
    'logical-clocks-simulator': 'Logical Clocks Simulator',
    'mapreduce-simulator': 'MapReduce Simulator',
    'circuit-breaker-simulator': 'Circuit Breaker Simulator',
    'rate-limiter-simulator': 'Rate Limiter Simulator',
    'two-phase-commit-simulator': 'Two-Phase Commit Simulator',
    'three-phase-commit-simulator': 'Three-Phase Commit Simulator',
    ...
    'truth-table-generator': 'Truth Table Generator',
    'string-escape': 'String Escape / Unescape',
    ...
    'svg-blob-generator': 'SVG Blob Generator',
    ...
    'css-mask-generator': 'CSS Mask Generator',
    ...
    'json-to-types': 'JSON → Multi-Language Types',
    'json-flatten': 'JSON Flatten & Unflatten',
    ...
    'docker-run-to-compose': 'Docker run → Compose',
    'docker-compose-visualizer': 'docker-compose Visualizer',
    ...
    'font-stack-generator': 'Font Stack Generator',
    ...
    'playwright-cheatsheet': 'Playwright (E2E) Cheat Sheet',
    ...
    'terraform-cheatsheet': 'Terraform Cheat Sheet',
    'nodejs-cheatsheet': 'Node.js Cheat Sheet',
    'postgresql-cheatsheet': 'PostgreSQL Cheat Sheet',
    'go-cheatsheet': 'Go Cheat Sheet',
    'rust-cheatsheet': 'Rust Cheat Sheet',
    'java-cheatsheet': 'Java Cheat Sheet',
    'sqlite-cheatsheet': 'SQLite Cheat Sheet',
    'ffmpeg-cheatsheet': 'FFmpeg Cheat Sheet',
    'csharp-cheatsheet': 'C# (.NET) Cheat Sheet',
    'php-cheatsheet': 'PHP Cheat Sheet',
    'kotlin-cheatsheet': 'Kotlin Cheat Sheet',
    'tcpdump-cheatsheet': 'tcpdump Cheat Sheet',
    'jwt-claims-cheatsheet': 'JWT Claims Cheat Sheet',
    'oauth2-cheatsheet': 'OAuth2 / OIDC Cheat Sheet',
    'design-patterns-cheatsheet': 'Design Patterns Cheat Sheet',
    'grid-areas-generator': 'CSS Grid Areas Generator',
    'grid-builder': 'CSS Grid Builder',
    'pattern-background-generator': 'CSS Pattern Background Generator',
    'sitemap-generator': 'XML Sitemap Generator',
    'web-app-manifest-generator': 'Web App Manifest Generator',
    'json-ld-generator': 'Structured Data Generator (JSON-LD / schema.org)',
    ...
    'svg-sprite-generator': 'SVG Sprite Generator',
    ...
    'image-palette-extractor': 'Image Palette Extractor',
    'image-diff-visualizer': 'Image Diff Visualizer',
    ...
    'css-supports-generator': 'CSS @supports Generator',
    'css-layer-generator': 'CSS @layer Generator',
    'favicon-generator': 'Favicon Generator',
    'nginx-config-generator': 'Nginx Config Generator',
    'ssh-config-generator': 'SSH Config Generator',
    'disk-performance-calculator': 'Disk Performance Calculator',
    'systemd-unit-generator': 'systemd Unit Generator',
    'shields-badge-generator': 'Badge Generator',
    ...
    'grpc-cheatsheet': 'gRPC & Protobuf Cheat Sheet',
  ...
  return [
    ...
    { key: '/bastidores', icon: <HistoryOutlined />, label: l.bastidores },
    {
      ...
      children: [
        ...
        { key: '/tools/base58-tool', icon: <SwapOutlined />, label: withNewBadge('/tools/base58-tool', l['base58-tool'], l) },
        { key: '/tools/base85-tool', icon: <SwapOutlined />, label: withNewBadge('/tools/base85-tool', l['base85-tool'], l) },
        { key: '/tools/uuid-generator', icon: <IdcardOutlined />, label: withNewBadge('/tools/uuid-generator', l['uuid-generator'], l) },
        { key: '/tools/uuid-v7-tool', icon: <IdcardOutlined />, label: withNewBadge('/tools/uuid-v7-tool', l['uuid-v7-tool'], l) },
        { key: '/tools/snowflake-id-tool', icon: <CloudOutlined />, label: withNewBadge('/tools/snowflake-id-tool', l['snowflake-id-tool'], l) },
        ...
        { key: '/tools/utm-url-builder', icon: <LinkOutlined />, label: withNewBadge('/tools/utm-url-builder', l['utm-url-builder'], l) },
        { key: '/tools/email-signature-generator', icon: <MailOutlined />, label: withNewBadge('/tools/email-signature-generator', l['email-signature-generator'], l) },
        { key: '/tools/config-converter', icon: <SwapOutlined />, label: withNewBadge('/tools/config-converter', l['config-converter'], l) },
        { key: '/tools/sql-in-list-generator', icon: <DatabaseOutlined />, label: withNewBadge('/tools/sql-in-list-generator', l['sql-in-list-generator'], l) },
        ...
        { key: '/tools/memory-allocation-simulator', icon: <HddOutlined />, label: withNewBadge('/tools/memory-allocation-simulator', l['memory-allocation-simulator'], l) },
        { key: '/tools/raft-simulator', icon: <ApartmentOutlined />, label: withNewBadge('/tools/raft-simulator', l['raft-simulator'], l) },
        { key: '/tools/paxos-simulator', icon: <ApartmentOutlined />, label: withNewBadge('/tools/paxos-simulator', l['paxos-simulator'], l) },
        { key: '/tools/bully-algorithm-simulator', icon: <ApartmentOutlined />, label: withNewBadge('/tools/bully-algorithm-simulator', l['bully-algorithm-simulator'], l) },
        { key: '/tools/ring-election-simulator', icon: <SyncOutlined />, label: withNewBadge('/tools/ring-election-simulator', l['ring-election-simulator'], l) },
        ...
        { key: '/tools/unicode-normalizer', icon: <FontSizeOutlined />, label: withNewBadge('/tools/unicode-normalizer', l['unicode-normalizer'], l) },
        ...
        { key: '/tools/pix-payload-generator', icon: <AccountBookOutlined />, label: withNewBadge('/tools/pix-payload-generator', l['pix-payload-generator'], l) },
        ...
        { key: '/tools/ab-test-calculator', icon: <ExperimentOutlined />, label: withNewBadge('/tools/ab-test-calculator', l['ab-test-calculator'], l) },
        { key: '/tools/littles-law-calculator', icon: <CalculatorOutlined />, label: withNewBadge('/tools/littles-law-calculator', l['littles-law-calculator'], l) },
        { key: '/tools/queueing-theory-calculator', icon: <CalculatorOutlined />, label: withNewBadge('/tools/queueing-theory-calculator', l['queueing-theory-calculator'], l) },
        { key: '/tools/pert-calculator', icon: <ProjectOutlined />, label: withNewBadge('/tools/pert-calculator', l['pert-calculator'], l) },
        ...
        { key: '/tools/load-balancer-simulator', icon: <PartitionOutlined />, label: withNewBadge('/tools/load-balancer-simulator', l['load-balancer-simulator'], l) },
        { key: '/tools/consistent-hashing-simulator', icon: <ApartmentOutlined />, label: withNewBadge('/tools/consistent-hashing-simulator', l['consistent-hashing-simulator'], l) },
        { key: '/tools/hash-table-visualizer', icon: <TableOutlined />, label: withNewBadge('/tools/hash-table-visualizer', l['hash-table-visualizer'], l) },
        { key: '/tools/bloom-filter-simulator', icon: <ExperimentOutlined />, label: withNewBadge('/tools/bloom-filter-simulator', l['bloom-filter-simulator'], l) },
        { key: '/tools/cpu-scheduling-simulator', icon: <ClockCircleOutlined />, label: withNewBadge('/tools/cpu-scheduling-simulator', l['cpu-scheduling-simulator'], l) },
        { key: '/tools/disk-scheduling-simulator', icon: <HddOutlined />, label: withNewBadge('/tools/disk-scheduling-simulator', l['disk-scheduling-simulator'], l) },
        { key: '/tools/gossip-protocol-simulator', icon: <ApartmentOutlined />, label: withNewBadge('/tools/gossip-protocol-simulator', l['gossip-protocol-simulator'], l) },
        { key: '/tools/mapreduce-simulator', icon: <ApartmentOutlined />, label: withNewBadge('/tools/mapreduce-simulator', l['mapreduce-simulator'], l) },
        { key: '/tools/page-replacement-simulator', icon: <ExperimentOutlined />, label: withNewBadge('/tools/page-replacement-simulator', l['page-replacement-simulator'], l) },
        { key: '/tools/cache-simulator', icon: <DatabaseOutlined />, label: withNewBadge('/tools/cache-simulator', l['cache-simulator'], l) },
        { key: '/tools/merkle-tree-simulator', icon: <ApartmentOutlined />, label: withNewBadge('/tools/merkle-tree-simulator', l['merkle-tree-simulator'], l) },
        { key: '/tools/quorum-nwr-simulator', icon: <ApartmentOutlined />, label: withNewBadge('/tools/quorum-nwr-simulator', l['quorum-nwr-simulator'], l) },
        { key: '/tools/descriptive-statistics-calculator', icon: <CalculatorOutlined />, label: withNewBadge('/tools/descriptive-statistics-calculator', l['descriptive-statistics-calculator'], l) },
        { key: '/tools/bmi-calculator', icon: <CalculatorOutlined />, label: withNewBadge('/tools/bmi-calculator', l['bmi-calculator'], l) },
        ...
        { key: '/tools/deadlock-simulator', icon: <ApartmentOutlined />, label: withNewBadge('/tools/deadlock-simulator', l['deadlock-simulator'], l) },
        { key: '/tools/truth-table-generator', icon: <CalculatorOutlined />, label: withNewBadge('/tools/truth-table-generator', l['truth-table-generator'], l) },
        ...
        { key: '/tools/matrix-calculator', icon: <CalculatorOutlined />, label: withNewBadge('/tools/matrix-calculator', l['matrix-calculator'], l) },
        ...
        { key: '/tools/image-to-ascii', icon: <PictureOutlined />, label: withNewBadge('/tools/image-to-ascii', l['image-to-ascii'], l) },
        { key: '/tools/image-resizer', icon: <PictureOutlined />, label: withNewBadge('/tools/image-resizer', l['image-resizer'], l) },
        { key: '/tools/image-palette-extractor', icon: <PictureOutlined />, label: withNewBadge('/tools/image-palette-extractor', l['image-palette-extractor'], l) },
        { key: '/tools/image-diff-visualizer', icon: <DiffOutlined />, label: withNewBadge('/tools/image-diff-visualizer', l['image-diff-visualizer'], l) },
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/snippets/priority-queue', icon: <SortAscendingOutlined />, label: withNewBadge('/snippets/priority-queue', l['priority-queue'], l) },
      ],
    },
    {
      key: 'group-frontend',
      ...
      children: [
        ...
        { key: '/frontend/svg-blob-generator', icon: <PictureOutlined />, label: withNewBadge('/frontend/svg-blob-generator', l['svg-blob-generator'], l) },
        { key: '/frontend/svg-optimizer', icon: <CompressOutlined />, label: withNewBadge('/frontend/svg-optimizer', l['svg-optimizer'], l) },
        ...
        { key: '/frontend/css-mask-generator', icon: <BgColorsOutlined />, label: withNewBadge('/frontend/css-mask-generator', l['css-mask-generator'], l) },
        ...
        { key: '/frontend/font-stack-generator', icon: <FontSizeOutlined />, label: withNewBadge('/frontend/font-stack-generator', l['font-stack-generator'], l) },
        ...
        { key: '/frontend/svg-sprite-generator', icon: <PictureOutlined />, label: withNewBadge('/frontend/svg-sprite-generator', l['svg-sprite-generator'], l) },
        ...
        { key: '/frontend/css-supports-generator', icon: <BgColorsOutlined />, label: withNewBadge('/frontend/css-supports-generator', l['css-supports-generator'], l) },
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/devops/env-file-validator', icon: <FileProtectOutlined />, label: withNewBadge('/devops/env-file-validator', l['env-file-validator'], l) },
        ...
        { key: '/devops/docker-compose-visualizer', icon: <ApartmentOutlined />, label: withNewBadge('/devops/docker-compose-visualizer', l['docker-compose-visualizer'], l) },
        ...
        { key: '/devops/haproxy-config-generator', icon: <PartitionOutlined />, label: withNewBadge('/devops/haproxy-config-generator', l['haproxy-config-generator'], l) },
        ...
        { key: '/devops/disk-performance-calculator', icon: <HddOutlined />, label: withNewBadge('/devops/disk-performance-calculator', l['disk-performance-calculator'], l) },
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/data/json-path-builder', label: withNewBadge('/data/json-path-builder', l['json-path-builder'], l) },
        ...
        { key: '/data/json-to-types', icon: <CodeOutlined />, label: withNewBadge('/data/json-to-types', l['json-to-types'], l) },
        { key: '/data/json-to-zod-schema', icon: <CodeOutlined />, label: withNewBadge('/data/json-to-zod-schema', l['json-to-zod-schema'], l) },
        { key: '/data/json-to-graphql', icon: <ApartmentOutlined />, label: withNewBadge('/data/json-to-graphql', l['json-to-graphql'], l) },
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/network/mac-address-generator', icon: <GlobalOutlined />, label: withNewBadge('/network/mac-address-generator', l['mac-address-generator'], l) },
        ...
        { key: '/network/sse-tester', icon: <ApiOutlined />, label: withNewBadge('/network/sse-tester', l['sse-tester'], l) },
    ...
    },
    {
      ...
      label: l.ai,
      children: [
        { key: '/ai/llm-cost-calculator', label: withNewBadge('/ai/llm-cost-calculator', l['llm-cost-calculator'], l) },
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/text/lines-processor', icon: <OrderedListOutlined />, label: withNewBadge('/text/lines-processor', l['lines-processor'], l) },
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/references/intellij-shortcuts', icon: <CodeOutlined />, label: withNewBadge('/references/intellij-shortcuts', l['intellij-shortcuts'], l) },
        ...
        { key: '/references/rsync-cheatsheet', icon: <SyncOutlined />, label: withNewBadge('/references/rsync-cheatsheet', l['rsync-cheatsheet'], l) },
        { key: '/references/tar-compression-cheatsheet', icon: <CompressOutlined />, label: withNewBadge('/references/tar-compression-cheatsheet', l['tar-compression-cheatsheet'], l) },
        { key: '/references/python-cheatsheet', icon: <CodeOutlined />, label: withNewBadge('/references/python-cheatsheet', l['python-cheatsheet'], l) },
        { key: '/references/grep-sed-awk-cheatsheet', icon: <ColumnWidthOutlined />, label: withNewBadge('/references/grep-sed-awk-cheatsheet', l['grep-sed-awk-cheatsheet'], l) },
        { key: '/references/jq-cheatsheet', icon: <CodeOutlined />, label: withNewBadge('/references/jq-cheatsheet', l['jq-cheatsheet'], l) },
        { key: '/references/curl-cheatsheet', icon: <SendOutlined />, label: withNewBadge('/references/curl-cheatsheet', l['curl-cheatsheet'], l) },
        { key: '/references/bash-scripting-cheatsheet', icon: <CodeOutlined />, label: l['bash-scripting-cheatsheet'] },
        ...
        { key: '/references/redis-cheatsheet', icon: <DatabaseOutlined />, label: withNewBadge('/references/redis-cheatsheet', l['redis-cheatsheet'], l) },
        { key: '/references/kubectl-commands', icon: <ClusterOutlined />, label: withNewBadge('/references/kubectl-commands', l['kubectl-commands'], l) },
        { key: '/references/openssl-commands', icon: <ContainerOutlined />, label: withNewBadge('/references/openssl-commands', l['openssl-commands'], l) },
        ...
        { key: '/references/playwright-cheatsheet', icon: <ExperimentOutlined />, label: withNewBadge('/references/playwright-cheatsheet', l['playwright-cheatsheet'], l) },
        ...
        { key: '/references/sqlite-cheatsheet', icon: <DatabaseOutlined />, label: withNewBadge('/references/sqlite-cheatsheet', l['sqlite-cheatsheet'], l) },
        { key: '/references/ffmpeg-cheatsheet', icon: <SoundOutlined />, label: withNewBadge('/references/ffmpeg-cheatsheet', l['ffmpeg-cheatsheet'], l) },
        { key: '/references/csharp-cheatsheet', icon: <CodeOutlined />, label: withNewBadge('/references/csharp-cheatsheet', l['csharp-cheatsheet'], l) },
        ...
        { key: '/references/grpc-cheatsheet', icon: <NodeIndexOutlined />, label: withNewBadge('/references/grpc-cheatsheet', l['grpc-cheatsheet'], l) },
        { key: '/references/ruby-cheatsheet', icon: <CodeOutlined />, label: withNewBadge('/references/ruby-cheatsheet', l['ruby-cheatsheet'], l) },
        { key: '/references/swift-cheatsheet', icon: <CodeOutlined />, label: withNewBadge('/references/swift-cheatsheet', l['swift-cheatsheet'], l) },
        ...
        { key: '/references/django-cheatsheet', icon: <CodeOutlined />, label: withNewBadge('/references/django-cheatsheet', l['django-cheatsheet'], l) },
        ...
        { key: '/references/design-patterns-cheatsheet', icon: <BookOutlined />, label: withNewBadge('/references/design-patterns-cheatsheet', l['design-patterns-cheatsheet'], l) },
        ...
        { key: '/references/vue-cheatsheet', icon: <CodeOutlined />, label: withNewBadge('/references/vue-cheatsheet', l['vue-cheatsheet'], l) },
        { key: '/references/angular-cheatsheet', icon: <CodeOutlined />, label: withNewBadge('/references/angular-cheatsheet', l['angular-cheatsheet'], l) },
