  ...
  return [
    ...
    },
    {
      ...
      children: [
        ...
        { key: '/frontend/image-palette-extractor', icon: <PictureOutlined />, label: withNewBadge('/frontend/image-palette-extractor', l['image-palette-extractor'], l) },
        { key: '/frontend/image-diff-visualizer', icon: <DiffOutlined />, label: withNewBadge('/frontend/image-diff-visualizer', l['image-diff-visualizer'], l) },
