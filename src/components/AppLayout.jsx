...
export const LABELS = {
  pt: {
    ...
    'concurrency-throughput-calculator': 'Concorrência & Throughput',
  ...
  en: {
    ...
    'concurrency-throughput-calculator': 'Concurrency & Throughput Calculator',
  ...
  return [
    ...
    { key: '/bastidores', icon: <HistoryOutlined />, label: l.bastidores },
    {
      ...
      children: [
        ...
        { key: '/tools/network-latency-calculator', icon: <ThunderboltOutlined />, label: withNewBadge('/tools/network-latency-calculator', l['network-latency-calculator'], l) },
        ...
        { key: '/tools/concurrency-throughput-calculator', icon: <ThunderboltOutlined />, label: withNewBadge('/tools/concurrency-throughput-calculator', l['concurrency-throughput-calculator'], l) },
